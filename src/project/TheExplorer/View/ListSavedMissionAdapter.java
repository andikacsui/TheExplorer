...
public class ListSavedMissionAdapter extends BaseAdapter {
	...
	public ListSavedMissionAdapter(Activity a,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//
		// TextView judul =
		// (TextView)vi.findViewById(R.id.TextViewNamaSavedMisi); // title
		// TextView lokasi =
		// (TextView)vi.findViewById(R.id.TextViewSavedLokasi); // artist name
		// TextView keterangan =
		// (TextView)vi.findViewById(R.id.TextViewSavedDeskripsiMisi); //
		// duration
		//TextView status = (TextView) vi
		//		.findViewById(R.id.TextViewSavedStatusMisi);
